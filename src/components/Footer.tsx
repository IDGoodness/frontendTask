...
export default function Footer() {
  return (
    <footer
      className="w-full bg-[#180514] text-white pt-16 pb-10 border-t border-white/10"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 lg:space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-4 space-y-5">
            <Link
              href="/"
              className="inline-block focus:outline-none focus:ring-2 focus:ring-[#EE4857] rounded"
            >
            ...
            <p className="text-xs sm:text-sm text-gray-300 leading-relaxed max-w-75 font-normal">
        ...
        <div className="bg-[#FFFFFF0F] rounded-md sm:rounded-md p-6 sm:p-8 md:p-10 border border-white/5 shadow-inner">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-8 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs sm:text-[13px] text-gray-300 leading-relaxed">
                ...
                {/* Nigeria Address */}
                <div className="space-y-1 lg:border-l lg:border-white/10 lg:pl-10">
                  <p className="text-[#EE4857] font-semibold text-xs sm:text-sm">
                    Nigeria
                  </p>
                  <p>
